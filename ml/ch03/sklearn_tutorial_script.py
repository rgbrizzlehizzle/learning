...
print('Labels counts in y:', numpy.bincount(y))
print('Labels counts in y_train:', numpy.bincount(y_train))
print('Labels counts in y_test:', numpy.bincount(y_test))
...
print('Accuracy: %.3f' % perceptron.score(X_test_std, y_test))
